...
export default function Login() {
  ...
  const handleSendOtp = async () => {
    ...
    setError('');
    try {
      await axios.post('http://https://just-helps-foundation-project.vercel.app/api/auth/send-otp', { 
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let res;
      if (useOtp) {
        res = await axios.post('http://https://just-helps-foundation-project.vercel.app/api/auth/login-with-otp', {
          email: formData.email,
          otp: formData.otp
        });
      } else {
        res = await axios.post('http://https://just-helps-foundation-project.vercel.app/api/auth/login', {
          email: formData.email,
